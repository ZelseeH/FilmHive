...
def get_rating_by_id(rating_id):
    try:
        return rating_repo.get_by_id(rating_id)  # <-- zwraca obiekt Rating lub None
...
def get_movie_ratings(movie_id, page=1, per_page=10):
    try:
        ...
        return {
            "ratings": result["ratings"],  # <-- lista obiektów Rating
...
def update_rating(rating_id, new_rating_value, user_id):
    try:
        ...
        return {"rating": updated_rating, **stats}
    except ValueError as e:
        raise e
    except Exception as e:
