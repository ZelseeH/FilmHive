...
def get_user_by_id(user_id):
    try:
        ...
        return user  # <-- zwracaj obiekt User lub None
...
def upload_profile_picture(user_id, file):
    try:
        ...
        return updated_user  # <-- zwracaj obiekt User
    except Exception as e:
...
def get_recent_rated_movies(user_id, limit=5):
    try:
        ...
        return recent_movies  # <-- lista obiektów Movie
    except Exception as e:
        raise Exception(
...
def get_recent_watchlist_movies(user_id, limit=6):
    try:
        ...
        return result.get("movies", [])  # <-- lista obiektów Movie
    except Exception as e:
        raise Exception(
...
def search_users(query, page=1, per_page=10):
    try:
        ...
        return {"users": users, "pagination": pagination}  # <-- lista obiektów User
    except Exception as e:
